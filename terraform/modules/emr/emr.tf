resource "aws_emr_cluster" "cluster" {
  ...
  security_configuration            = aws_emr_security_configuration.external_batch_emrfs_em.id
  ...
  depends_on = [
    ...
    aws_emr_security_configuration.external_batch_emrfs_em,
  ]
...
resource "aws_cloudwatch_event_rule" "cluster_bootstrap_event_rule" {
  name        = "external-batch-emr-bootstrap-event-rule"
...
resource "aws_cloudwatch_metric_alarm" "emr_terminated_with_errors_alarm" {
  ...
  alarm_description         = "This metric monitors invocations of the external-batch-emr-bootstrap-event-rule"
