...
# UC Labs EMR cluster configuration files
resource "aws_s3_bucket_object" "uc_labs_cluster" {
  bucket = var.config_bucket.id
...
resource "aws_s3_bucket_object" "uc_labs_instances" {
  bucket = var.config_bucket.id
  key    = "emr/uc-labs-cluster-config/instances.yaml"
  content = templatefile("../../../batch_cluster_config/instances.yaml.tpl", {
    common_security_group    = var.common_security_group
    master_security_group    = var.master_security_group
    slave_security_group     = var.slave_security_group
...
resource "aws_s3_bucket_object" "uc_labs_steps" {
  bucket = var.config_bucket.id
...
# Payment timelines EMR cluster configuration files
resource "aws_s3_bucket_object" "payment_timelines_cluster" {
  bucket = var.config_bucket.id
...
resource "aws_s3_bucket_object" "payment_timelines_instances" {
  bucket = var.config_bucket.id
  key    = "emr/payment-timelines-cluster-config/instances.yaml"
  content = templatefile("../../../batch_cluster_config/instances.yaml.tpl", {
    common_security_group    = var.common_security_group
    master_security_group    = var.master_security_group
    slave_security_group     = var.slave_security_group
...
resource "aws_s3_bucket_object" "payment_timelines_steps" {
  bucket = var.config_bucket.id
...
resource "aws_s3_bucket_object" "payment_timelines_configurations" {
  bucket = var.config_bucket.id
  key    = "emr/payment-timelines-cluster-config/configurations.yaml"
  content = templatefile("../../../batch_cluster_config/configurations.yaml.tpl", {
    config_bucket                = var.emr_bucket.id
    log_bucket                   = var.log_bucket
    proxy_host                   = var.proxy_host
...
# Batch EMR cluster config files
resource "aws_s3_bucket_object" "test_batch_cluster" {
  bucket = var.config_bucket.id
...
resource "aws_s3_bucket_object" "test_batch_instances" {
  bucket = var.config_bucket.id
  key    = "emr/test-batch-cluster/instances.yaml"
  content = templatefile("../../../test_batch_cluster_config/instances.yaml.tpl", {
    common_security_group    = var.common_security_group
    master_security_group    = var.master_security_group
    slave_security_group     = var.slave_security_group
    service_security_group   = var.service_security_group
    subnet_ids               = join(",", var.subnet_ids)
    core_instance_count      = var.test_core_instance_count
    instance_type_master     = var.instance_type_master
    instance_type_core_one   = var.instance_type_core_one
    instance_type_core_two   = var.instance_type_core_two
    instance_type_core_three = var.instance_type_core_three
...
resource "aws_s3_bucket_object" "test_batch_steps" {
  bucket = var.config_bucket.id
...
resource "aws_s3_bucket_object" "test_batch_configurations" {
  bucket = var.config_bucket.id
  key    = "emr/test-batch-cluster/configurations.yaml"
  content = templatefile("../../../test_batch_cluster_config/configurations.yaml.tpl", {
    config_bucket                = var.emr_bucket.id
    log_bucket                   = var.log_bucket
    proxy_host                   = var.proxy_host
    full_no_proxy                = var.full_no_proxy
  ...
  tags = merge(var.common_tags, { Name : "test-batch-emr-launch-config" })
}
