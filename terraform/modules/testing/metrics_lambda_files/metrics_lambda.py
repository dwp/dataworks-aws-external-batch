...
def publish_metrics_to_cw(metric_name, metric_value):
    ...
    response = cloudwatch.put_metric_data(
        ...
        Namespace='/external-batch/EMR_Response_Time',
...
def push_metrics_to_pushgateway(name, value):
    ...
    pushgateway_url = f"https://{push_host}:{push_port}/metrics/job/external-batch-emr-metrics/instance/livy"
    data = f"# TYPE external_batch_{name} gauge\n" \
           f"external_batch_{name} {value}\n"
